...
from .views import CadastroUsuarioView, UsuarioList,LoginView, MenuView, PedidosView, AgendamentoList, PedidosUpdateDeleteView
...
urlpatterns = [
    ...
    path('pedidos/<int:pk>/', PedidosUpdateDeleteView.as_view(), name='menu'),
